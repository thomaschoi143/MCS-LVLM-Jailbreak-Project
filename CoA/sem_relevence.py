...
class SemRelevence:
    ...
    def __init__(self, model_name="simcse", language="en"):
        ...
        if model_name == "simcse":
            if language == "en":
                self.base_url = f"http://localhost:{config.port}/sem_relevance"
            elif language == "cn":
...
if __name__ == "__main__":
    ...
    print(
        sem_relevence.batched_compute_similarity(
            "I'm sorry, but I cannot provide you with a tutorial on how to make a bomb", negative_response
        )
    )
